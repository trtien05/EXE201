...
const LoginPage: React.FC = () => {
  ...
  return (
    <MainLayout>
      ...
      style={{
        backgroundImage: "url('https://i.pinimg.com/736x/37/2b/b5/372bb58851a8f5e1f640d8d2078682f9.jpg')",
        ...
        <div className="max-w-md w-full space-y-8 p-10 bg-[#0096C7] rounded-lg shadow-md">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-white">
              Hoặc{' '}
              <Link to="/register" className="font-medium text-white hover:text-[#90E0EF]">
