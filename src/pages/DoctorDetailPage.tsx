    ...
    return (
      <MainLayout>
        <div className="container mx-auto px-52 py-16 text-center">
          ...
          <p className="text-gray-600 mb-6">Bác sĩ bạn đang tìm kiếm không tồn tại hoặc đã bị xóa.</p>
          <Link to="/doctors">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-1/3">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Thông tin nhanh</h3>
              <div className="space-y-4 mb-6">
                ...
                <div>
                  ...
                  <p className="font-medium">{doctor.rating}/5 ({doctor.reviews.length} đánh giá)</p>
                </div>
              </div>
