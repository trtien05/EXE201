...
const DueDateCalculatorForm = () => {
  ...
  const generateCycleLengthOptions = () => {
    const options = [
      <Option key="unknown" value="I don't know">
        I don&apos;t know
      </Option>,
    ];
    for (let i = 20; i <= 45; i++) {
      options.push(
        <Option key={i} value={`${i} days`}>
          {i} days
        </Option>
      );
    }
            ...
            <div className="form-group">
              ...
              >
                <Space direction="vertical">
                  <Radio value="IVF 3 Day Transfer Date">
                    IVF 3 Day Transfer Date
                  </Radio>
                  <Radio value="IVF 5 Day Transfer Date">
  ...
  return (
    <div className="due-date-calculator-form">
      ...
      {error && (
        <Alert message={error} type="error" style={{ marginBottom: "15px" }} />
      )}
