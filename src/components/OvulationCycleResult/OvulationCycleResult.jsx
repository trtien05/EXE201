      ...
      <div className="cycle-info">
        <div className="info-item-over">
          ...
          <div className="info-content">
            ...
            <div className="info-value">
              {formatDate(currentMonthData.menstruationDate)}
            </div>
          </div>
        </div>
        ...
        <div className="info-item-over">
          ...
          <div className="info-content">
            ...
            <div className="info-value">
              {formatDate(currentMonthData.fertileStart)} -{" "}
              {formatDate(currentMonthData.fertileEnd)}
            </div>
          </div>
        </div>
        ...
        <div className="info-item-over">
          ...
          <div className="info-content">
            ...
            <div className="info-value">
              {formatDate(currentMonthData.dueDate)}
            </div>
          </div>
        </div>
      </div>
